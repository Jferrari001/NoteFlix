        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">                
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <!--begin::Item-->
                    <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                    <a href="/Noteflix/Criador/Visualizar" class="text-white text-hover-white opacity-75 hover-opacity-100">Visualizar</a>
                    <!--end::Item-->                    
                </div>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card card-custom card-padrao">
        ...
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label font-weight-bolder text-dark">Visualizar Criador</h3>
            </div>
        ...
        <div class="card-body">
            <form id="Form">
                ...
                <div class="form-group">
                    <label>Nome</label>
                    <input type="text" name="CriadorNome" class="form-control" id="CriadorNome" value="<?php echo $Nome; ?>" disabled>
                </div>
            </form>            
        </div>                    
        <!--end::Body-->
