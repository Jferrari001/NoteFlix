        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">                
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <!--begin::Item-->
                    <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                    <a href="/Noteflix/Filme/Alterar" class="text-white text-hover-white opacity-75 hover-opacity-100">Alterar</a>
                    <!--end::Item-->                    
                </div>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card card-custom card-padrao">
        ...
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label font-weight-bolder text-dark">Alterar Filme</h3>
            </div>
        ...
        <div class="card-body">
            <form id="Form">
                ...
                <div class="form-group">
                    <label>Nome</label>
                    <input type="text" class="form-control" name="FilmeNome" id="FilmeNome" value="<?php echo $Nome; ?>" >
                </div>
                <div class="form-group">   
                    <label>Duração</label>
                ...
                <div class="form-group">
                    <label>Trailer</label>
                    <input type="text" class="form-control" name="FilmeTrailer" id="FilmeTrailer" value="<?php echo $Trailer; ?>" >
                </div>
                <div class="form-group">
                    <label>Foto</label>                               
                ...
                <div class="form-group"> 
                    <label>Sinopse</label>
                    <textarea rows="5" class="form-control" name="FilmeSinopse" id="FilmeSinopse" maxlength="1000" ><?php echo $Sinopse; ?></textarea>
                </div>
