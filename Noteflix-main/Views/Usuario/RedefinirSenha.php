...
<html lang="pt-BR">
	...
	<head><base href="../../../">
		...
		<link href="/Noteflix/Metronic/demo2/dist/assets/css/pages/login/login-2.css" rel="stylesheet" type="text/css" />
	...
	<!--end::Head-->
	<!--begin::Body-->
	<body id="kt_body" style="background-image: url(/Noteflix/Metronic/demo2/dist/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
		<!--begin::Main-->
			...
			<div class="login login-2 login-signin-on d-flex flex-column flex-lg-row flex-column-fluid bg-white" id="kt_login">
				...
				<div class="login-aside order-2 order-lg-1 d-flex flex-row-auto position-relative overflow-hidden">
					...
					<div class="d-flex flex-column-fluid flex-column justify-content-between py-9 px-7 py-lg-13 px-lg-35">
						<!--begin::Logo-->
						<a href="/Noteflix/Home/Index" class="text-center pt-2">
							<img src="/Noteflix/Content/icon/noteflix.png" class="max-h-75px" alt="" />
						</a>
						<!--end::Logo-->
						<!--begin::Aside body-->
							...
							<div class="login-form login-reset pt-11">
								...
								<form class="form" novalidate="novalidate" id="kt_login_reset_form">
									...
									<div class="text-center pb-8">
										<h2 class="font-weight-bolder text-dark font-size-h2 font-size-h1-lg">Redefinir Senha</h2>
										<p class="text-muted font-weight-bold font-size-h4">Preencha as informações para redefinir sua senha.</p>
									</div>
									<!--end::Title-->
									<!--begin::Form group-->
									<div class="form-group d-none">
										<input class="form-control form-control-solid h-auto py-7 px-6 rounded-lg font-size-h6" type="hidden" placeholder="Token" name="token" autocomplete="off" value="<?php echo $Token; ?>" />
									</div>
									<!--end::Form group-->								
									<!--begin::Form group-->
		...
		<script src="/Noteflix/Scripts/Usuario/RedefinirSenha.js"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>
