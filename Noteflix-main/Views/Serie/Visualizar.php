        ...
        <div class="d-flex align-items-center flex-wrap mr-1">
            ...
            <div class="d-flex flex-column">                
                ...
                <div class="d-flex align-items-center font-weight-bold my-2">
                    ...
                    <!--begin::Item-->
                    <span class="label label-dot label-sm bg-white opacity-75 mx-3"></span>
                    <a href="/Noteflix/Serie/Visualizar" class="text-white text-hover-white opacity-75 hover-opacity-100">Visualizar</a>
                    <!--end::Item-->                    
                </div>
                <!--end::Breadcrumb-->
            </div>
    ...
    <div class="card card-custom card-padrao">
        ...
        <div class="card-header">
            <div class="card-title">
                <h3 class="card-label font-weight-bolder text-dark">Visualizar Série</h3>
            </div>
        ...
        <div class="card-body">
            <form id="Form">
                ...
                <div class="form-group">
                    <label>Nome</label>
                    <input type="text" class="form-control" name="SerieNome" id="SerieNome" value="<?php echo $Nome; ?>" disabled>
                </div>
                <div class="form-group">   
                    <label>Primeiro Episódio</label>
                    <div class="input-group date">
                        <input type="text" class="form-control" name="SeriePrimeiroEp" id="SeriePrimeiroEp" placeholder="Defina a data" autocomplete="off" value="<?php echo implode("/",array_reverse(explode("-", $PrimeiroEpisodio))); ?>" disabled />
                ...
                <div class="form-group"> 
                    ...
                    <input type="number" class="form-control" min="1" name="SerieNumeroTemp" id="SerieNumeroTemp" value="<?php echo $NumeroTemporada; ?>" disabled />
                </div>
                <div class="form-group"> 
                ...
                <div class="form-group"> 
                    <label>Criador</label>
                    <select class="form-control select2" name="SerieCriador" id="SerieCriador" disabled>
                ...
                <div class="form-group">       
                    <label>Elenco</label>
                    <select class="form-control select2" name="SerieElenco" id="SerieElenco" multiple="multiple" disabled>
                ...
                <div class="form-group">       
                    <label>Gênero</label>
                    <select class="form-control select2" name="SerieGenero" id="SerieGenero" multiple="multiple" disabled>
                ...
                <div class="form-group"> 
                    ...
                    <select class="form-control select2" name="SeriePlataforma" id="SeriePlataforma" multiple="multiple" disabled>
                ...
                <div class="form-group">
                    <label>Trailer</label>
                    <input type="text" class="form-control" name="SerieTrailer" id="SerieTrailer" value="<?php echo $Trailer; ?>" disabled>
                </div>
                <div class="form-group">
                    <label>Foto</label>                               
                ...
                <div class="form-group"> 
                    <label>Sinopse</label>
                    <textarea rows="5" class="form-control" name="SerieSinopse" id="SerieSinopse" maxlength="1000" disabled><?php echo $Sinopse; ?></textarea>
                </div>
        ...
        <div class="card-footer">
            <a href="/Noteflix/Serie/Index" class="btn btn-lg btn-secondary font-weight-bold mr-2">Voltar</a>
        </div>
        <!--end:Footer-->
    </div>
    <!--end::Card-->        
